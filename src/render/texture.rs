...
impl Texture {
    ...
    pub fn create_white_texture(device: &wgpu::Device, queue: &wgpu::Queue, label: &str, layout: &wgpu::BindGroupLayout) -> Self {
        ...
        queue.write_texture(
            ...
            &[255, 255, 255, 255], // Pure White Pixel
        ...
        let bind_group = device.create_bind_group(&wgpu::BindGroupDescriptor {
            layout, entries: &[wgpu::BindGroupEntry { binding: 0, resource: wgpu::BindingResource::TextureView(&view) }, wgpu::BindGroupEntry { binding: 1, resource: wgpu::BindingResource::Sampler(&sampler) }], label: Some(label),
        });
    ...
    pub fn from_bytes(
        device: &wgpu::Device, queue: &wgpu::Queue, bytes: &[u8], label: &str, layout: &wgpu::BindGroupLayout,
    ) -> Result<Self> {
